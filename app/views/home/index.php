         ...
         <div class="container">
            <div class="row margin_bottom_30">
               ...
               <div class="col-md-6 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s">
                  <div class="full">
                     <div class="center"><img src="<?= BASEURL ?>/asset/images/ser1.png" alt="#" /></div>
                  </div>
               </div>
               <!-- end featured image -->
            </div>
            <div class="row margin_bottom_30">
               ...
               <div class="col-md-6 wow fadeInLeft" data-wow-delay="0.5" data-wow-duration="1s">
                  <div class="full">
                     <div class="center"><img src="<?= BASEURL ?>/asset/images/ser2.png" alt="#" /></div>
                  </div>
               </div>
               <!-- end featured image -->
               <!-- featured cont -->
            ...
            <div class="row margin_bottom_30">
               ...
               <div class="col-md-6 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s">
                  <div class="full">
                     <div class="center"><img src="<?= BASEURL ?>/asset/images/ser3.png" alt="#" /></div>
                  </div>
               </div>
               <!-- end featured image -->
            </div>
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="information_blogs">
                     <div class="imf_icon"><img src="<?= BASEURL ?>/asset/images/icon1.png" alt="#" /></div>
                     <div class="imf_head">
               ...
               <div class="col-md-4">
                  <div class="information_blogs">
                     <div class="imf_icon"><img src="<?= BASEURL ?>/asset/images/icon3.png" alt="#" /></div>
                     <div class="imf_head">
         ...
         <div class="container">
            ...
            <div class="row app-features">
               ...
               <div class="col-md-4 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s">
                  <div class="full">
                     <div class="center">
                        <img src="<?= BASEURL ?>/asset/images/application_screen.png" alt="#" />
                     </div>
                  </div>
               </div>
            </div>
